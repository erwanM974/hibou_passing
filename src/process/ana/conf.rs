...
use crate::core::execution::trace::flags::MultiTraceAnalysisFlags;
...
impl AnalysisStaticLocalVerdictAnalysisProof {
    pub fn new(local_coloc: CoLocalizations, local_interaction: Interaction, local_multi_trace: MultiTrace, local_flags: MultiTraceAnalysisFlags) -> Self {
        AnalysisStaticLocalVerdictAnalysisProof { local_coloc, local_interaction, local_multi_trace, local_flags }
    }
}
