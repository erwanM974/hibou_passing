...
use crate::io::output::to_hfiles::trace::trace_action::trace_action_as_htf_encoding;
...
pub fn multi_trace_as_htf_encoding(gen_ctx : &GeneralContext,
    ...
    for (canal_id,coloc_lfs) in co_localizations.locs_lf_ids.iter().enumerate() {
        ...
        for action in canal_trace {
            trace_text_elements.push( trace_action_as_htf_encoding(gen_ctx, action) );
        }
